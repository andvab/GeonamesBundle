 ...
 * AlternateNames
 *
 * @ORM\Table(name="andvab_geonames_alternate_names", indexes={@ORM\Index(name="alternate_name_id", columns={"alternate_name_id"}), @ORM\Index(name="geoname_id", columns={"geoname_id"}), @ORM\Index(name="iso_language", columns={"iso_language"}), @ORM\Index(name="is_preferred_name", columns={"is_preferred_name"}), @ORM\Index(name="is_short_name", columns={"is_short_name"}), @ORM\Index(name="is_colloquial", columns={"is_colloquial"}), @ORM\Index(name="is_historic", columns={"is_historic"})})
 * @ORM\Entity
 */

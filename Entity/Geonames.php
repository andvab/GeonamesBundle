 ...
 * Geonames
 *
 * @ORM\Table(name="andvab_geonames", indexes={@ORM\Index(name="geoname_id", columns={"geoname_id"}), @ORM\Index(name="feature_class", columns={"feature_class"}), @ORM\Index(name="country_code", columns={"country_code"}), @ORM\Index(name="cc2", columns={"cc2"}), @ORM\Index(name="admin1_code", columns={"admin1_code"}), @ORM\Index(name="admin2_code", columns={"admin2_code"}), @ORM\Index(name="admin3_code", columns={"admin3_code"}), @ORM\Index(name="admin4_code", columns={"admin4_code"}), @ORM\Index(name="timezone", columns={"timezone"})})
 * @ORM\Entity
 */
class Geonames
{

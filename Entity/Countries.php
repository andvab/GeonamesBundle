 ...
 * Countries
 *
 * @ORM\Table(name="andvab_geonames_countries", indexes={@ORM\Index(name="iso", columns={"iso"}), @ORM\Index(name="iso3", columns={"iso3"}), @ORM\Index(name="iso_numeric", columns={"iso_numeric"}), @ORM\Index(name="geoname_id", columns={"geoname_id"})})
 * @ORM\Entity
 */
class Countries
{
